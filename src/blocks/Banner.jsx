...
import logoBanner from 'banner-logo-le2023.svg'
  ...
  return (
    ...
    >
      <div className={styles.electionLogo}>
        ...
        <img src={logoBanner} alt="Leadership Elections 2023" />
        </a>
      </div>
      ...
      {!countdownCompleted && (
        <div className={styles.voteButton}>
          <Button href='https://vote.union.ic.ac.uk' target='_blank' className={props.season != 'autumn' ? 'vote' : ''}>
            Vote
          </Button>
        </div>
      )}
