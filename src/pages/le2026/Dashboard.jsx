...
import Logo from '../../components/Logos/le2026/Logo'
  ...
  return (
    ...
    >
      ...
      <section className={`${styles.grid} ${styles.sourceToggle}`}>
        <span>
          Viewing{' '}
          <span data-tooltip="The 'Main' or 'General Elections' stats relate to votes for any of the non-CSP positions which are grouped as 'Leadership Elections 2026' on eVoting. The 'CSPs' stats relate to votes for any of the Club, Society or Project positions which are grouped as 'Leadership Elections 2026 (Clubs, Societies and Projects) on eVoting.">
