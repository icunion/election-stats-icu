  ...
  return (
    ...
    >
      ...
      <section className={`${styles.grid} ${styles.sourceToggle}`}>
        <span>
          Viewing{' '}
          <span data-tooltip="The 'Main' or 'General Elections' stats relate to votes for any of the non-CSP positions which are grouped as 'Leadership Elections 2024' on eVoting. The 'CSPs' stats relate to votes for any of the Club, Society or Project positions which are grouped as 'Leadership Elections 2024 (Clubs, Societies and Projects) on eVoting.">
