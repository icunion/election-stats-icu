    ...
    <div className={styles.toolbar}>
      <label>
        ...
        <select value={selected} onChange={selectOnChange}>
          ...
          <option value='DashboardLE2026'>DashboardLE2026</option>
          <option value='DashboardLE2026.maxWidth'>
            DashboardLE2026 with maxWidth set
          </option>
          <option value='StepByStepLE2026.maxWidth'>
            Step By Step 2026 with maxWidth set
          </option>
